...
public class Inventory : MonoBehaviour , ISaveManager
{
    ...
    {
        if (_item.itemType == ItemType.装备 && CanAddItem())
            AddToInventory(_item);
        else if (_item.itemType == ItemType.材料)
            AddToStash(_item);
    ...
    {
        ItemData_Equipment currentFlask = GetEquipment(EquipmentType.道具);
    ...
    {
        ItemData_Equipment currentArmor = GetEquipment(EquipmentType.防具);
